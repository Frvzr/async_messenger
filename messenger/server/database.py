from sqlalchemy import create_engine, Table, Column, Integer, String, ForeignKey, DateTime, Text
...
class ServerStorage:
    ...
    def __init__(self, path):
        ...
        active_users_table = Table(
            'Active_users', self.mapper_registry.metadata, Column(
        ...
        users_history_table = Table('History', self.mapper_registry.metadata,
                                    Column('id', Integer, primary_key=True),
                                    Column('user', ForeignKey('Users.id')),
                                    Column('sent', Integer),
        ...
        self.mapper_registry.map_imperatively(self.UsersHistory, users_history_table)
